...
namespace GameLoan.Infrastructure.Repository.UnitOfWork
{
    public class UnitOfWork : IUnitOfWork, IDisposable
    {
        ...
        public UnitOfWork(string contextConnection, string contextDatabase, RepositoryConfig repositoryConfig)
        {
        ...
        private IGameLoanContext Context
        {
            get
            {
                return _context ??= new GameLoanContext(_contextConnection, _contextDatabase);
            }
        }
